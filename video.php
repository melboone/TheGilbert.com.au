<?php $title = 'Video Presentation - The Gilbert, Preston'; include("includes/header.php"); ?>
<div class="container bg8 menu8">
	<div class="wrapper">
		<div class="menu"><?php require($DOCUMENT_ROOT . "includes/menu.php"); ?></div>
		<div class="content"><?php require($DOCUMENT_ROOT . "includes/pages/video.php"); ?></div>
	</div>
</div>
